...
#Se importan los datos de los pozos del proyecto Platero

x_pozo_inv_kale, y_pozo_inv_kale  = 4901360, 2360010
h_pozo_inv_kale_m = 3227.8 #m

x_pozo_iny_kale, y_pozo_iny_kale  = 4901300, 2359950
...
card_main=dbc.Card(
    dbc.CardBody([
                ...
                html.H2("Semáforo sísmico- Platero", className="card-title"),
...
def update_output(pozo,Fecha,Hora,Minuto,Segundo,n_clicks):
        if pozo=='INY':
            kale,nam,geo_inv,cyl1,bcircles1,cyl2,bcircles2,cyl3,bcircles3,sismos_total,sismos_local,Mc,ND,mn,nmsod_mn,npseod_mn,d_mn,x_pozo_inv_kale,y_pozo_inv_kale,r1,r_ext,gw,ge,gs,gn=kale1,nam1,geo_inv1,cyl11,bcircles11,cyl21,bcircles21,cyl31,bcircles31,sismos_total1,sismos_local1,Mc1,ND1,mn1,nmsod_mn1,npseod_mn1,d_mn1,x_pozo_inv_kale1,y_pozo_inv_kale1,r11,r_ext1,gw1,ge1,gs1,gn1
        else:
            kale,nam,geo_inv,cyl1,bcircles1,cyl2,bcircles2,cyl3,bcircles3,sismos_total,sismos_local,Mc,ND,mn,nmsod_mn,npseod_mn,d_mn,x_pozo_inv_kale,y_pozo_inv_kale,r1,r_ext,gw,ge,gs,gn=kale2,nam2,geo_inv2,cyl12,bcircles12,cyl22,bcircles22,cyl32,bcircles32,sismos_total2,sismos_local2,Mc2,ND2,mn2,nmsod_mn2,npseod_mn2,d_mn2,x_pozo_inv_kale2,y_pozo_inv_kale2,r12,r_ext2,gw2,ge2,gs2,gn2
        Hora=str(Hora)
        Minuto=str(Minuto)
        Segundo=str(Segundo)
